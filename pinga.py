...
from mininet.link import Intf # add physical interface
import time
import os
...
#    r1.cmd('ripd -f /usr/local/etc/r1ripd.conf -d -i ~/Desktop/r1ripd > ~/Desktop/r1ripd.log')
    ...
    r1.cmd('ospfd -f /usr/local/etc/r1bgpd.conf -d -z ~/Desktop/r1zebra.api -i ~/Desktop/r1ospfd.interface')

#    r2.cmd('ripd -f /usr/local/etc/r2ripd.conf -d -i ~/Desktop/r2ripd > ~/Desktop/r2ripd.log')
    r2.cmd('ospfd -f /usr/local/etc/r2bgpd.conf -d -z ~/Desktop/r2zebra.api -i ~/Desktop/r2ospfd.interface')
